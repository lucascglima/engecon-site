...
const Testimonials = () => {
  ...
  return (
    <section
      className="testim-modrn2 section-padding sub-bg"
      data-scroll-index="4"
    >
        ...
        <div className="row">
          <div className="col-lg-4 valign">
            <div className="cont-head md-mb50">
              <span className="sub-title fw-200 yellow-green-color">
                Testimonials
              </span>
              ...
              <div className="controls position-re flex mt-40">
                ...
                <div
                  className="swiper-button-next swiper-nav-ctrl next-ctrl cursor-pointer ml-10"
                    ...
                    <div className="item flex">
                      ...
                      <div className="cont">
                        ...
                        <div className="info flex">
                          ...
                          <span className="fz-14 fw-200 yellow-green-color">
                            {slide.position}
                          </span>
                        </div>
                      </div>
