...
import features from "../../../data/business/features-imp.json";
    ...
    >
      <div className="container">
        <div className="row">
              ...
              {services ? (
                <h2 className="fw-600 ">
                  ...
                  <span className="fw-600 green-text">
                    {" "}
                    Tratamento de fundação com Reação Álcali-Agregado - RAA?
                  </span>{" "}
                </h2>
              ) : (
          ...
          {/* <div className={`col-lg-3 ${services ? "" : "col-md-6"} valign`}>
            <div className={`exp ${services ? "" : "m-auto"}`}>
              <div className="flex">
                <h2
                  className={`lg-text gr-green-text ${
                    services ? "fw-600" : "fw-700 line-height-1"
                  }`}
                >
                  {features.years}
                </h2>
