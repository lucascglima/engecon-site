...
import process from "../../../data/business/process-rec.json";
        ...
        <div className="row">
          <div className="col-lg-5">
            <div className="round-head mb-80">
              ...
              <h5 className="fw-700 mb-40">Reforço de prédio tipo caixão</h5>
            </div>
          ...
          <div className="col-lg-6 offset-lg-1 valign">
            <div className="img out-box mt-50">
              <img
                src="img/engecon/estrutural/horizontal/2.webp"
                alt=""
