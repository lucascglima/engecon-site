...
const Footer = ({ footerClass, type }) => {
  ...
  return (
    <footer className={footerClass}>
      ...
      >
        <div
          className={`call-action-banner pt-60 pb-60 position-re radius-30 ${
            type == "purple-light" ? "gr-blue2-bg" : "mb-100"
          } ${type == "purple-red" ? "gr-purple-red-bg" : ""}`}
          data-overlay-dark="0"
        >
            ...
            <div className="col-lg-7">
              <div className="text">
                ...
                <p className="text-light">
                  Tell us which describes you, and we&lsquo;ll get in touch with
                  next steps.
                </p>
              </div>
            </div>
        ...
        <div className="row">
          <div className="col-lg-3">
            <div className="clumn">
              ...
              <div className="text">
                <p>
                  Morbi sagittis hendrt nulla simply text of the printing and
                  has beenthe industry’s en diam pretium.
                </p>
              </div>
            ...
            <div className="clumn">
              ...
              <ul className="address rest">
                ...
                <li className="tel">
                  <h6
                    className={`${
                      type == "purple-red" ? "gr-purple-red-text" : ""
          ...
          <div className="row">
            ...
            <div className="col-lg-6">
              <div className="copyrights d-flex justify-content-end">
                <p className="fz-13">
                  © 2022 engecon is Proudly Powered by
