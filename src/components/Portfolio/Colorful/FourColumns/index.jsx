...
import data from '../../../../data/portfolio/colorful/four-columns.json';
          ...
          <div className="row">
            {
              data.gallery.map((item, index) => (
                <div className={`col-lg-3 col-md-6 items mt-30 md-getter ${item.filter} wow fadeInUp`} data-wow-delay=".4s" key={index}>
